    ...
    <div class="app-badges mt-10">
              <ul>               
                <v-responsive class="pt-3">
                      ...
                      <li><v-avatar><img src="../assets/python.png" alt="python"></v-avatar></li>
                      ...
                      <li><v-avatar><img src="../assets/android.png" alt="android"></v-avatar></li>
                      <li><v-avatar><img src="../assets/firebase.png" alt="firebase"></v-avatar></li>
